...
class TestFrontendFiles(unittest.TestCase):
    def test_index_references_assets(self):
        ...
        self.assertIn('id="llmCommandInput"', content)
    ...
    def test_app_fetches_games_endpoint(self):
        ...
        self.assertIn("llmCommandInput.value.trim()", content)
        self.assertIn("{ llm_command: llmCommand }", content)
        self.assertIn("JSON.stringify(requestBody)", content)
    ...
    def test_styles_define_table_layout(self):
        ...
        self.assertIn(".explanation-command", content)
